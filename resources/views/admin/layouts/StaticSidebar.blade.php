              ...
              <ul role="list" class="flex flex-1 flex-col gap-y-7">
                  <li>
                      <ul role="list" class="-mx-2 space-y-1">
                          ...
                          @php
                              $isActive = request()->is('admin/dashboard'); // Cek apakah URL yang sedang diakses adalah '/admin/categories'
                          @endphp
                          ...
                          @php
                              $isActive = request()->is('admin/categories'); // Cek apakah URL yang sedang diakses adalah '/admin/categories'
                          @endphp
                          ...
                          @php
                              $isActive = request()->is('admin/products'); // Cek apakah URL yang sedang diakses adalah '/admin/categories'
                          @endphp
